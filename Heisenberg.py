...
def greet():
    ...
    conn.commit()
    conn.close()
    SR.speak("\nMyself Shridhar's Assistant. How may I help you?")
    ...
    try:
        while(True):
            ...
            #asking for name
                ...
                SR.speak("My name is Shridhar's Assistant and I'm here to serve you.")
            #How are you
                ...
                conn.close()
            #what is my name
            elif there_exists(['what is my name','tell me my name',"i don't remember my name","my name"],query):
                SR.speak("Your name is "+str(getpass.getuser()))

            #calendar
            elif there_exists(['show me calendar','display calendar','calendar'],query):
                SR.updating_ST(calendar.calendar(2024))

            #google, youtube and location
            #playing on youtube
            elif there_exists(['open youtube','open youtube and play','on youtube','youtube'],query):
            ...
            # top 5 news
            elif there_exists(['top 5 news','top five news','listen some news','news of today','news'],query):
...
if __name__=="__main__":
        ...
        scrollable_text=scrolledtext.ScrolledText(root,state='disabled',height=768,width=1024,relief='sunken',bd=5,wrap=tk.WORD,bg='red',fg='#800000')
